...
def step_solver(cc, amps=None, max_cycle=50,
                ...
                max_memory=None, verbose=logger.INFO):
    """
    Solves CC by simply iterating an update generated by
    a cc object, with possible exponential averaging.
...
def gradient_solver(cc, amps=None, max_cycle=50,
    ...
    for istep in range(max_cycle):
        step = cc.calculate_gradient(ham, amps)
