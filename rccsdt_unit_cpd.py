...
class RCCSDT_UNIT_nCPD_LS_T(RCCSDT_UNIT_CPD_LS_T):
    """
    This class implements classic RCCSDT method with
...
class RCCSDT_UNIT_nCPD_T_LS_T(RCCSDT_UNIT_nCPD_LS_T):
    """
    This class implements classic RCCSDT method with
...
class RCCSDT_UNIT_nCPD_T_LS_T_HUB(RCCSDT_UNIT_nCPD_T_LS_T):
    """
